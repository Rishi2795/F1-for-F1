                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full space-y-8">
                      ...
                      <div className="flex items-end justify-between">
                        ...
                        <div className={`px-2 py-1 rounded-sm text-[11px] font-black italic ${t.gained >= 0 ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-600'
                          }`}>
                        ...
                        <div className="flex gap-1 h-1 w-full bg-zinc-50 md:group-hover:bg-zinc-900 transition-colors">
                          {[...Array(10)].map((_, i) => {
                            ...
                            return (
                              <div
                                key={i}
                                className={`flex-1 transition-all duration-700 ${isActive ? 'bg-zinc-200 md:group-hover:bg-zinc-700' : 'bg-transparent'
                                  }`}
                                style={{
              ...
              {race.drivers.map((d: any) => {
                ...
                return (
                  <div
                    ...
                    className={`group relative flex flex-col transition-all duration-300 cursor-pointer ${isExpanded ? 'bg-white z-20' : 'bg-[#080808] hover:bg-[#0c0c0c]'
                      }`}
                  >
                    ...
                    <div className="flex items-center justify-between px-4 py-2 md:py-3 relative overflow-hidden">
                      ...
                      <span className={`absolute left-20 text-4xl font-black italic transition-all pointer-events-none uppercase ${isExpanded ? 'text-zinc-100 opacity-100' : 'text-white/[0.02]'
                        }`}>
                        {d.driver_code}
                      </span>
                      ...
                      <div className="relative z-10 flex items-center gap-6">
                        ...
                        <div className="flex items-baseline gap-3">
                          <h4 className={`text-sm md:text-base font-black uppercase tracking-tighter ${isExpanded ? 'text-black' : 'text-white'
                            }`}>
                            {d.driver_code}
                          </h4>
                      ...
                      <div className="relative z-10 flex items-center gap-10">
                        ...
                        <div className="flex flex-col items-end w-12">
                          <span className={`text-sm md:text-lg font-black italic ${d.positions_gained >= 0 ? 'text-green-500' : 'text-red-600'
                            }`}>
                            {d.positions_gained > 0 ? `+${d.positions_gained}` : d.positions_gained}
                          </span>
                        </div>

                        <div className={`w-1 h-6 transition-colors ${isExpanded ? 'bg-red-600' : 'bg-zinc-800 group-hover:bg-zinc-700'
                          }`} />
                      </div>
                    </div>

                    {/* --- DENSE TECH EXPANSION --- */}
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isExpanded ? 'max-h-[300px]' : 'max-h-0'
                      }`}>
